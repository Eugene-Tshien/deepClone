...
# adapted from official Spider evaluation file: https://github.com/taoyds/spider.git
...
def print_scores(scores, etype):
    ...
    if etype in ["all", "exec"]:
        ...
        print('===========================   Validity   ===========================')
        this_scores = [scores[level]['valid'] for level in levels]
        print("{:20} {:<20.3f} {:<20.3f} {:<20.3f} {:<20.3f} {:<20.3f}".format("valid", *this_scores))
...
def evaluate(gold, predict, db_dir, etype, kmaps):
    ...
    for p, g in zip(plist, glist):
        ...
        if etype in ["all", "exec"]:
            ...
            if exec_score:
                ...
                scores['all']['exec'] += 1.0
            valid_score = isValidSQL(p_str, db)
            if valid_score:
                scores[hardness]['valid'] += 1.0
                scores['all']['valid'] += 1.0
    ...
    for level in levels:
        ...
        if etype in ["all", "exec"]:
            ...
            scores[level]['valid'] /= scores[level]['count']
